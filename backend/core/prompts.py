STORY_PROMPT = """
You are a creative story writer that creates engaging choose-you-own adventure stories.
...
4. Some paths should lead to endings (both winning and losing endings)
5. At least one path should lead to a winning ending

Story structure requirements:
- Each node should have 2-3 options except for the ending nodes
- The story should be 3-4 levels up deep (including root node)
